...
class RedisRoutes:
    def __init__(self, redis_url):
        self.redis_client = redis_client = redis.from_url(redis_url)
        self.router = router = APIRouter()
        
        @router.websocket("/redis/ws/pubsub/{channel}")
        ...
        @router.delete("/redis/delete/{key}")
